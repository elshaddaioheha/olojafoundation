        ...
        <section className="relative z-20 -mt-20 container mb-20 px-4 md:px-8" id="stats">
            ...
            >
                ...
                <motion.div
                    ...
                    className="bg-[#EA580C] text-white p-12 md:p-16 flex flex-col justify-center"
                >
                    <motion.span variants={{ hidden: { opacity: 0, y: 10 }, visible: { opacity: 0.8, y: 0 } }} className="uppercase text-xs font-bold tracking-widest mb-4">Who We Are</motion.span>
                    <motion.h2 variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }} className="text-2xl md:text-3xl font-bold mb-6 leading-tight">
                        To build a community where people receive support and empowerment.
                    </motion.h2>
                    <motion.div variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 0.9, y: 0 } }} className="text-white mb-8 leading-relaxed space-y-4 text-sm md:text-base">
                        <p>
                    ...
                    <motion.div variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }} className="flex flex-col md:flex-row gap-8">
                ...
                <motion.div
                    ...
                    className="relative bg-gray-900 min-h-[500px]"
                >
